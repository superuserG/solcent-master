...
@endif
      ...
      {{Form::open(['route'=>'admin.category.store','class'=>'form-horizontal'])}}
      ...
      <form class="form-horizontal">
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input name="category" class="form-control" id="inputCategory" placeholder="Category" type="text" required>
            </div>
          </div>
        </div>
        <!-- /.box-body -->
        <div class="box-footer">
          <button type="submit" class="btn btn-info pull-right button-addAuthor">Add Category</button>
        </div>
        <!-- /.box-footer -->
      </form>
    </div>
  {{Form::close()}}
        ...
        <table id="tableCategory" class="tbl-category">
        <thead>
          <tr>
            <th>No.</th>
            <th>Service</th>
